...
//  Input:
//
//    integer Q: the number of points in the circle.
//
//    integer P: the point to which point 0 is connected.
//
//    integer A, B: the scales for x(i) = cos ( A * 2 * pi * i / Q )
//    and y(i) = sin ( A * 2 * pi * i / Q ).
//
{
  char title[80];
